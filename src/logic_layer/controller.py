...
----------------------------------------------------
    Trivedi et al. (2023). IRCoT: Iterative Retrieval with
        Chain-of-Thought. ACL. arXiv:2212.10509.
    Gutiérrez et al. (2024). HippoRAG: Neurobiologically Inspired
        Long-Term Memory for LLMs. NeurIPS. arXiv:2405.14831.
    Press et al. (2022). Measuring and Narrowing the Compositionality
        Gap in Language Models (Self-Ask). EMNLP.
    Khattab et al. (2022). Demonstrate-Search-Predict (DSP).
        arXiv:2212.14024.
...
class AgenticController:
    ...
    # this thesis. Sourced from the manual error analysis of the dev split,
    ...
    def _extract_bridge_entities(
        ...
        # scoring instance of each distinct candidate.
        ...
        for prop in proposals:
            ...
            score = cls._score_bridge_candidate(
                prop.text, prop.chunk, query, expected_type, chunk_rank=prop.rank,
            )
