...
"EM = 0.44". A point estimate alone cannot answer the question a thesis
...
# ── Reproducibility ──────────────────────────────────────────────────────────
# A fixed default seed makes every CI in the thesis reproducible. Callers can
# override per call; the thesis evaluation should use the default so re-running
